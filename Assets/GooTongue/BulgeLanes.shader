	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 lerpResult30 = lerp( UnpackNormalScale( tex2D( _GooTongue_TongueMaterial_Normal, uv_GooTongue_TongueMaterial_Normal ), 1.0f ) , unpack29 , saturate( tex2DNode8.r ));
				...
				float temp_output_43_0 = saturate( sign( ( texCoord41.y - ( 1.0 - _BulgeClip ) ) ) );
				float4 lerpResult36 = lerp( float4( 0,0,0,0 ) , color37 , saturate( ( abs( dotResult31 ) * tex2DNode8.r * temp_output_43_0 ) ));
...
/*ASEBEGIN
Version=18935
376;383;2027;725;2204.319;135.3007;1.432854;True;True
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;-363.7823,421.3253;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;29;-1260.647,-88.79173;Inherit;True;Property;_BulgeLanes_normal;BulgeLanes_normal;28;0;Create;True;0;0;0;False;0;False;-1;236f8c747dc5c8f488e26fe8896968d1;236f8c747dc5c8f488e26fe8896968d1;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;2;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;49;-143.8751,463.6322;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;50;-876.0638,565.3648;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=957D6990E1899C3CD7EB88DE584A6094552D1DE7